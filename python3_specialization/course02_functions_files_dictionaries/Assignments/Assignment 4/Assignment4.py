...
plt.title("Football NFC North Division Team Performance 1970 to 2016 \n (10 Year Moving Average)")
plt.legend(["Green Bay Packers","Chicago Bears","Detroit Lions","Minnesota Vikings"],
           loc=8,ncol=2,frameon=False)
sns.set_style("whitegrid", {'axes.grid' : False})
for spine in plt.gca().spines.values():
    spine.set_visible(False)
plt.xlabel("Season Played \n (1970-2001 NFC Central, 2002-2016 NFC North)")
plt.ylabel("Wins as Percent of Played Games")
